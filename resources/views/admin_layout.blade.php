      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{('public/fronten/dist/img/user3-128x128.jpg')}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="{{ URL::to('add_service') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm dịch vụ</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ URL::to('admin/service/index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{URL::to('laravel-filemanager?type=Files')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Quản lý file</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{URL::to('laravel-filemanager?type=Images')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Quản lý ảnh</p>
                </a>
              </li>
